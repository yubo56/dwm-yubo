...
static const char *browser[] = { "_dwm_browser_launch", NULL };
static const char *toggle-transp[] = { "_dwm_toggle_transp", NULL };
static const char *brightup[] = { "_dwm_brightup", NULL };
static const char *brightdown[] = { "_dwm_brightdown", NULL };
static const char *changekeys[] = { "_dwm_changekeys", NULL };
static const char *toggleInt[] = { "_dwm_toggle_keybd", NULL };
static const char *tptoggle[] = { "_dwm_tptoggle", NULL };
static const char *gdict[] = { "goldendict", NULL };
static const char *paste_x[] = { "_dwm_paste_x", NULL };
static const char *paste_c[] = { "_dwm_paste_x", "-c", NULL };
static const char *quick_type[] = { "_dwm_quick_type", "_run", NULL };

static const char *xscreensaver_custom[] = { "_dwm_xscreensaver_error", "-lock", NULL };
static const char *xscreensaver_blank[] = { "_dwm_xscreensaver_blank", "-lock", NULL };
static const char *rebg[] = { "_dwm_rebg", NULL };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_n,      spawn,          {.v = toggle-transp } },
